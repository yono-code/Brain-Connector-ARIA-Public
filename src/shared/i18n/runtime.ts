...
const EN_MESSAGES = {
  ...
  'wv.toolbar.add_person': '+ Person',
  'wv.toolbar.title_add_person': 'Add person node',
  'wv.toolbar.add_database': '+ Database',
  'wv.toolbar.title_add_database': 'Add database node',
  'wv.toolbar.add_module': '+ Module',
  'wv.toolbar.title_add_module': 'Add capsule module node',
  'wv.toolbar.editing': 'Editing: {{label}}',
  'wv.toolbar.add_node': '+ Node',
  'wv.toolbar.title_add_node': 'Add mindmap node',
  'wv.toolbar.mermaid_import': 'Import Mermaid',
  'wv.toolbar.title_mermaid_import': 'Import Mermaid text into mindmap',
  'wv.toolbar.align_surface': 'Align',
  'wv.toolbar.title_align_surface': 'Auto align current diagram (Ctrl/Cmd+Shift+L)',
  'wv.toolbar.align_tree': 'Align Tree',
  'wv.toolbar.title_align_tree': 'Align mindmap as a core-rooted tree',
  ...
  'wv.toolbar.shortcut_hint': 'Ctrl+N: Add Task | Ctrl/Cmd+Shift+L: Align | Right Click: Menu',
  ...
  'seed.person.new': 'New User',
  'seed.database.new': 'New Database',
  'seed.module.new': 'New Module',
...
const JA_MESSAGES: Record<I18nKey, string> = {
  ...
  'wv.toolbar.add_person': '+ 人型',
  'wv.toolbar.title_add_person': 'ユーザーノードを追加',
  'wv.toolbar.add_database': '+ DB',
  'wv.toolbar.title_add_database': 'データベースノードを追加',
  'wv.toolbar.add_module': '+ モジュール',
  'wv.toolbar.title_add_module': 'カプセル型モジュールを追加',
  'wv.toolbar.editing': '編集中: {{label}}',
  'wv.toolbar.add_node': '+ ノード',
  'wv.toolbar.title_add_node': 'マインドマップノードを追加',
  'wv.toolbar.mermaid_import': 'Mermaid入力',
  'wv.toolbar.title_mermaid_import': 'Mermaidテキストをマインドマップへ取り込む',
  'wv.toolbar.align_surface': '整列',
  'wv.toolbar.title_align_surface': '現在の図を自動整列 (Ctrl/Cmd+Shift+L)',
  'wv.toolbar.align_tree': 'ツリー整列',
  'wv.toolbar.title_align_tree': 'コアノード起点のツリー状に整列',
  'wv.toolbar.undo': 'Undo',
  'wv.toolbar.redo': 'Redo',
  'wv.toolbar.snap_on': 'Snap: ON',
  'wv.toolbar.snap_off': 'Snap: OFF',
  ...
  'wv.toolbar.shortcut_hint': 'Ctrl+N: タスク追加 | Ctrl/Cmd+Shift+L: 整列 | 右クリック: メニュー',
  ...
  'seed.person.new': '新しいユーザー',
  'seed.database.new': '新しいデータベース',
  'seed.module.new': '新しいモジュール',
